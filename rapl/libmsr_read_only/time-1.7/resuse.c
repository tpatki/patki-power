...
resuse_start (resp)
     RESUSE *resp;
{
  /* Do a few chores before we start the timer */
  gethostname(resp->hostname, MAX_HOSTNAME_LEN);
  //rapl_init(NULL, stderr, 1);		// BLR
#if HAVE_WAIT3

...
int rdtruegrid_decomp(BlockMapping_t *map, int startblk, int ndlistflg, int *num_blocks);
...
int gnblk ;		/* The total number of domains in the problem.
...
int unblk ;	/* The number of user-specified blocks */

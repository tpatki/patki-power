...
#ifdef SILO
struct DBfile ;
int SourceNew_rdsilo (struct DBfile *idbid );
int SourceNew_wtsilo (struct DBfile *idbid );
#endif
...
int SourceNew_setattr( SourceNew_t *src );
int SourceNew_init( SourceNew_t *src );
...
void Source_merge(struct Domain_s *domain);
...
void SourceNew_release( SourceNew_t *src);
void SourceNew_add( SourceNew_t *src, HashTable_t *hash);
void SourceNew_general( double *field, double *weight, char *name, double dtime, struct Domain_s *domain, SourceEditMode_t ifedit);
void SourceNew_temperature( double *e, double *t, double *dedt, double *weight, char *name, double dtime, struct Domain_s *domain, SourceEditMode_t ifedit);
void SourceNew_energyrate( double *dele, double *weight, char *name, double dtime, double dterate, struct Domain_s *domain, SourceEditMode_t ifedit);
void SourceNew_radtemperature( double *phi, double *t, double *weight, char *name, double dtime, struct Domain_s *domain, SourceEditMode_t ifedit);
void SourceNew_table (SourceNew_t *src, double *value, double dtime, struct Domain_s *domain);
void SourceNew_domain(SourceNew_t *src, struct Domain_s *domain);
void SourceNew_getedits(double *src_mass, double *src_e, double *src_xmom, double *src_ymom, double *src_zmom);

...
!    Per Cycle Edits
     ...
     real(adqt), pointer :: RadEnergyEscRate(:,:)  ! RadEnergyEscRate(nbedit+1,ngr) 
     real(adqt), pointer :: RadEnergyIncRate(:,:)  ! RadEnergyIncRate(nbedit+1,ngr)
     real(adqt), pointer :: RadEnergyEscaped(:,:)  ! RadEnergyEscaped(nbedit+1,ngr)
     real(adqt), pointer :: RadEnergyIncident(:,:) ! RadEnergyIncident(nbedit+1,ngr)
...
!=======================================================================
  ...
  subroutine Editor_ctor(self, Size)
...
!   Allocate arrays in the edit object
    ...
    allocate( self % RadEnergyEscRate(Size%nbedit+1,Size%ngr) )
    allocate( self % RadEnergyIncRate(Size%nbedit+1,Size%ngr) )
    allocate( self % RadEnergyEscaped(Size%nbedit+1,Size%ngr) )
    allocate( self % RadEnergyIncident(Size%nbedit+1,Size%ngr) )

    self % RadEnergyEscRate(:,:)  = zero
    self % RadEnergyIncRate(:,:)  = zero
    self % RadEnergyEscaped(:,:)  = zero
...
!   Deallocate arrays in the edit object
    ...
    deallocate( self % RadEnergyEscaped  )
